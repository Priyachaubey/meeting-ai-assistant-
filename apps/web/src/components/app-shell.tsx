...
import { BarChart3, CreditCard, FileAudio2, FolderSearch, History, LayoutDashboard, LogOut, Plug, Settings, ShieldCheck, UserCircle, Users } from "lucide-react";
import { NotificationBell } from "@/components/notification-bell";
import { useAuthStore } from "@/store/auth-store";
const nav = [["Dashboard","/dashboard",LayoutDashboard],["Live","/live",FileAudio2],["Library","/history",History],["Knowledge","/knowledge",FolderSearch],["Team","/team",Users],["Analytics","/analytics",BarChart3],["Integrations","/integrations",Plug],["Admin","/admin",ShieldCheck],["Settings","/settings",Settings],["Billing","/billing",CreditCard],["Profile","/profile",UserCircle]] as const;
